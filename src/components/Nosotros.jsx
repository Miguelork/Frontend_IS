              ...
              <div id="collapseV" className="collapse bg-green brad mt-3 mb-3" style={{ "padding-top": "1rem" }} aria-labelledby="headV" data-parent="#bloqcontact">
                <div className="row">
                  ...
                  <h1 style={{ "color": "white" }} >Pedro Barrios</h1>
                    ...
                    <p style={{ "color": "white" }} class="lead">Me gusta programar en los lenguajes Java y Python. Soy bueno trabajando en el backend aunque también puedo llegar a ser detallista para el frontendThis is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p>
                    <p class="lead">
