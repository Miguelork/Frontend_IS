                        ...
                        <form role="form" id="regDoctor" class="php-email-form" style={{ "width": "100%" }}>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 form-group">
                                    <div className="input-group">
                                        ...
                                        <input type="text" id="docnombre" disabled name="nombre" onBlur={validarFormulario} onKeyUp={validarFormulario} className="form-control" placeholder="nombre" required />
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                                    <div className="input-group">
                                        ...
                                        <input type="text" id="docapellido" name="apellido" onBlur={validarFormulario} onKeyUp={validarFormulario} className="form-control" placeholder="apellido" required />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 form-group">
                                    <div className="input-group">
                                        ...
                                        <input type="text" id="docusuario" name="usuario" onBlur={validarFormulario} onKeyUp={validarFormulario} className="form-control" placeholder="usuario" required />
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                                    <div className="input-group">
                                        ...
                                        <input type="password" id="docpassword" name="password" onBlur={validarFormulario} onKeyUp={validarFormulario} className="form-control" placeholder="contraseña" required />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 form-group">
                                    <div className="input-group">
                                        ...
                                        <input type="text" id="doctelefono" name="telefono" onBlur={validarFormulario} onKeyUp={validarFormulario} className="form-control" placeholder="teléfono" required />
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                                    <div className="input-group">
                                        ...
                                        <input type="email" id="docemail" name="email" onBlur={validarFormulario} onKeyUp={validarFormulario} className="form-control" placeholder="email" required />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div className="input-group">
                                    ...
                                    <input type="text" id="docdireccion" name="direccion" onBlur={validarFormulario} onKeyUp={validarFormulario} className="form-control" placeholder="dirección" required />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 form-group">
                                    <div className="input-group">
                                        ...
                                        <input type="text" id="docespecialidad" name="especialidad" onBlur={validarFormulario} onKeyUp={validarFormulario} className="form-control" placeholder="especialidades" required />
                                    </div>
                                </div>
                                <div class="col-md-6 form-group">
                                    <div className="input-group">
...
async function registrarDoctor() {
    ...
    axios.get('https://dblinkmed.herokuapp.com/crearUsuario', {
        "tipo": Doctor.tipo,
