    ...
    return (
        <div className="container">
            ...
            <div data-aos="zoom-out" data-aos-delay={300}>
                <img src="assets/img/prueba perfil.png" className="col-md-5" alt="" />
            </div>           
                    ...
                    <div class="form-row">
                        <div class="col-md-6 form-group">
                            <div className="input-group">
                                ...
                                <input type="text" id="docnombre" disabled name="nombre" onBlur={validarFormulario} onKeyUp={validarFormulario} className="form-control" placeholder="Escriba su nombre" required />
                            </div>
                        </div>
                        <div class="col-md-6 form-group">
                            <div className="input-group">
