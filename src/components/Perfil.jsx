...
class Perfil extends React.Component {
    ...
    render() {
        return (
            <div>
                <Header></Header>
                <section id="hero" data-testid="Perfil">
                    <div className="container">
                        ...
                        <div className="row">
                            ...
                            <div data-aos="zoom-out" className="col-md-6" data-aos-delay={60} id="imagen">
                                <img id="imagenero" data-testid="imagenero" alt="" className="img-fluid" />
                            </div>
                            <div>
                                <p></p>
                                <p></p>
                        ...
                        <div className="row section-title" data-aos="fade-left" id="cargando" data-testid="cargando" style={{ "display": "none" }}>
                        ...
                        <div className="row" data-aos="fade-left">
                            <div role="form" id="Paciente" data-testid="Paciente" class="php-email-form" style={{ "width": "100%", "display": "none" }}>
                                <div class="row">
