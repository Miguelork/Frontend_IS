  ...
  constructor(props) {
    ...
    this.state = {
      caracter: [{
        ...
        "d2":"",
        "description": "Entendemos perfectamente la crisis que se esta viviendo en el mundo a partir de la pandemia, por lo que esta es una plataforma cuyo proposito es ayudar a las personas que lo requieran."
      }]
    }
  }
