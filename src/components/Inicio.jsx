  ...
  constructor(props) {
    ...
    this.state = {
      caracter: [{
        ...
        "d2":"",
        "description": "Entendemos perfectamente la crisis que se esta viviendo en el mundo a partir de la pandemia, por lo que esta es una plataforma cuyo proposito es ayudar a las personas que lo requieran en la brevedad posible."
      }]
    }
  }
              ...
              <div className="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                <div data-aos="zoom-out">
                  ...
                  <div className="text-center text-lg-left">
                    ...
                    <a href="https://www.youtube.com/embed/DUFsSw2b0Ok" className="ml-2 btn-get-started scrollto"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-circle" viewBox="0 0 16 16">
