...
class CatalogoDoctores extends React.Component {
    ...
    botonIniciarChat = (doctor, usuario) => {
        console.log(doctor, usuario)
        if (usuario.tipo == "Paciente") {
            return (
                <button href="#" onClick={() => iniciarChat(doctor, usuario)} class="btn-get-started mr-2 scrollto mt-3" style={{ "text-decoration": "none" }}>Iniciar Chat</button>
            )
        }
                                                ...
                                                <div class="row">
                                                    ...
                                                    {(item.tipo == "Premium") ?
                                                        <div>
                                                            ...
                                                            {(this.botonIniciarChat(item, cookies.get('usuario')))}
